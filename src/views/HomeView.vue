      ...
      <div class="sectionWrapperNoTop">
         ...
         <div class="paragraphMarginTop px-3 text-start">
            <span class="mainParagraphFontSize text-wrap"><b>We are a small, extremely mobile company based in Boise,
               Idaho.</b> Our most common work locations include
               California, Washington, Nevada, and of course, Idaho. We also frequently server
               Montana
               and Utah</span>
         </div>
         <div class="paragraphMarginTop px-3 text-start">
            <span class="mainParagraphFontSize text-wrap">
               Our team, though small, brings a decade of
               experience in track painting and construction. We take pride in our craftsmanship and are ready to tackle jobs of any
               size,
               always aiming to deliver outstanding results!
            </span>
         </div>
      </div>
      ...
      <div class="sectionWrapper sectionBGDark text-start">
         ...
         <div class="row mt-5">
            ...
            <div class="col-md-6 mt-3 mb-3 homeSectionTextPadding">
               <span class="mainParagraphFontSize text-wrap"><b>Strong surfaces, straight lines, beautiful curves, and accurately measured
                  start lines, lane numbers, hurdle
                  marks, exchange zone marks, and school name or mascot lettering.</b>
               </span>
               <br>
               <span class="mainParagraphFontSize text-wrap">
